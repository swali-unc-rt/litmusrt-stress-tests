...
// void FSMLP::get_fsmlp_lock() {
//     // struct control_page* cpage = get_ctrl_page();
//     // if( !cpage ) {
//     //     fprintf(stderr,"FSMLP: get_fsmlp_lock could not get control page\n");
//     //     return;
//     // }

//     // // Indicate we want to be non-preemptible
//     // cpage->sched.np.flag = 1;
//     MCSNode node;

//     fsmlp_lock.lock(&node);

//     // unsigned int my_ticket = next_ticket.fetch_add(1);

//     // while( now_serving.load() != my_ticket ) {
//     //     _mm_pause();
//     //     //printf("Waiting ticket\n");
//     // }
// }

// void FSMLP::exit_fsmlp_lock() {
//     // struct control_page* cpage = get_ctrl_page();
//     // if( !cpage ) {
//     //     fprintf(stderr,"FSMLP: exit_fsmlp_lock could not get control page\n");
//     //     return;
//     // }
...
void FSMLP::stop() {
    stopped = true;
    /*while( !pq.empty() || !fq.empty() || !sq.empty() ) {
        processQueues();
